...
## Project Structure
    ...
    ├── remember_me_mobile__38264  # Django project configurations
...
1. Clone this repo and `cd remember_me_mobile__38264`
...
2. Clone this repo and `cd remember_me_mobile__38264`
